...
global estimated_pqr estimated_P sensor_states_raw flag_sensor_uncertainty flag_model_uncertainty
%% model parameters
k_F = 6.11*10^-8;
k_M = 1.5*10^-9;
L = 0.175;
...
sensor_states_raw = zeros(12,simulation_time/step);
flag_sensor_uncertainty = 1;
flag_model_uncertainty = 1;
end
